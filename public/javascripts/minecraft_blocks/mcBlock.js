...
Blockly.Python['mcblock_all_attrs'] = function(block) {
    ...
    var value_list = block.getFieldValue("LIST");
    console.log(value_list);// can use dropdown in place of math block! need to get second dropdown working and modify how the block looks
